...
class ToneCmdGenerator(Enum):   # 可添加预设以生成其他音色的转换规则
    ...
    bass_harp = ToneConversionSettings(0, ('harp_-1',), (9, 32), 9)
    normal_harp = ToneConversionSettings(0, ('harp',), (33, 57), 33)
    treble_harp = ToneConversionSettings(0, ('harp_1',), (58, 81), 57)
    bass_bass = ToneConversionSettings(1, ('bass_-1',), (9, 32), 9)
    normal_bass = ToneConversionSettings(1, ('bass',), (33, 57), 33)
    treble_bass = ToneConversionSettings(1, ('bass_1',), (58, 81), 57)
    bass_basedrum = ToneConversionSettings(2, ('basedrum_-1',), (9, 32), 9)
    normal_basedrum = ToneConversionSettings(2, ('basedrum',), (33, 57), 33)
    treble_basedrum = ToneConversionSettings(2, ('basedrum_1',), (58, 81), 57)
    bass_snare = ToneConversionSettings(3, ('snare_-1',), (9, 32), 9)
    normal_snare = ToneConversionSettings(3, ('snare',), (33, 57), 33)
    treble_snare = ToneConversionSettings(3, ('snare_1',), (58, 81), 57)
    bass_hat = ToneConversionSettings(4, ('hat_-1',), (9, 32), 9)
    normal_hat = ToneConversionSettings(4, ('hat',), (33, 57), 33)
    treble_hat = ToneConversionSettings(4, ('hat_1',), (58, 81), 57)
    bass_guitar = ToneConversionSettings(5, ('guitar_-1',), (9, 32), 9)
    normal_guitar = ToneConversionSettings(5, ('guitar',), (33, 57), 33)
    treble_guitar = ToneConversionSettings(5, ('guitar_1',), (58, 81), 57)
    bass_flute = ToneConversionSettings(6, ('flute_-1',), (9, 32), 9)
    normal_flute = ToneConversionSettings(6, ('flute',), (33, 57), 33)
    treble_flute = ToneConversionSettings(6, ('flute_1',), (58, 81), 57)
    bass_bell = ToneConversionSettings(7, ('bell_-1',), (9, 32), 9)
    normal_bell = ToneConversionSettings(7, ('bell',), (33, 57), 33)
    treble_bell = ToneConversionSettings(7, ('bell_1',), (58, 81), 57)
    bass_chime = ToneConversionSettings(8, ('chime_-1',), (9, 32), 9)
    normal_chime = ToneConversionSettings(8, ('chime',), (33, 57), 33)
    treble_chime = ToneConversionSettings(8, ('chime_1',), (58, 81), 57)
    bass_xylophone = ToneConversionSettings(9, ('xylophone_-1',), (9, 32), 9)
    normal_xylophone = ToneConversionSettings(9, ('xylophone',), (33, 57), 33)
    treble_xylophone = ToneConversionSettings(9, ('xylophone_1',), (58, 81), 57)
    bass_iron_xylophone = ToneConversionSettings(10, ('iron_xylophone_-1',), (9, 32), 9)
    normal_iron_xylophone = ToneConversionSettings(10, ('iron_xylophone',), (33, 57), 33)
    treble_iron_xylophone = ToneConversionSettings(10, ('iron_xylophone_1',), (58, 81), 57)
    bass_cow_bell = ToneConversionSettings(11, ('cow_bell_-1',), (9, 32), 9)
    normal_cow_bell = ToneConversionSettings(11, ('cow_bell',), (33, 57), 33)
    treble_cow_bell = ToneConversionSettings(11, ('cow_bell_1',), (58, 81), 57)
    bass_didgeridoo = ToneConversionSettings(12, ('didgeridoo_-1',), (9, 32), 9)
    normal_didgeridoo = ToneConversionSettings(12, ('didgeridoo',), (33, 57), 33)
    treble_didgeridoo = ToneConversionSettings(12, ('didgeridoo_1',), (58, 81), 57)
    bass_bit = ToneConversionSettings(13, ('bit_-1',), (9, 32), 9)
    normal_bit = ToneConversionSettings(13, ('bit',), (33, 57), 33)
    treble_bit = ToneConversionSettings(13, ('bit_1',), (58, 81), 57)
    bass_banjo = ToneConversionSettings(14, ('banjo_-1',), (9, 32), 9)
    normal_banjo = ToneConversionSettings(14, ('banjo',), (33, 57), 33)
    treble_banjo = ToneConversionSettings(14, ('banjo_1',), (58, 81), 57)
    bass_pling = ToneConversionSettings(15, ('pling_-1',), (9, 32), 9)
    normal_pling = ToneConversionSettings(15, ('pling',), (33, 57), 33)
    treble_pling = ToneConversionSettings(15, ('pling_1',), (58, 81), 57)
