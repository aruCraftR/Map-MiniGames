...
execute if score @s bw.tmp.gd matches 8.. run give @s slime_ball{display:{Name:'"\\u00a7f击退棍"'},Enchantments:[{id:"knockback",lvl:1}],HideFlags:63,CanPlaceOn:["#minecraft:bwplace"],CanDestroy:["#minecraft:bedblocks"]} 1