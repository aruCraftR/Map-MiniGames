...
execute as @a[team=pw.play,gamemode=adventure] run item replace entity @s container.0 with slime_ball{Enchantments:[{id:"knockback",lvl:2}],Unbreakable:1b,display:{color:1105614},HideFlags:63} 1
