...
give @a[team=play.repel] minecraft:slime_ball{display:{Name:'["§aRepel"]',Lore:['["§rUse it to Shoot Down Other Players"]']},HideFlags:63,Enchantments:[{id:"minecraft:knockback",lvl:1s}],AttributeModifiers:[{AttributeName:"generic.attack_speed",Name:"noName",Amount:4d,Operation:0,UUID:[I;4651,1568,3158,3284]}]} 1
